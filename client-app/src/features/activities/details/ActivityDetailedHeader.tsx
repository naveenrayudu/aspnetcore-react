...
const ActivityDetailedHeader: React.FC<{
    ...
    const {activityStore: {cancelAttendee, attendActivity, loading}} = useContext(RootStoreContext);
    return (
        <Segment.Group>
            ...
            <Segment clearing attached='bottom'>
                {
                    activity.isHost ? (
                        ...
                        <Button color='teal' loading={loading} onClick={attendActivity}>Join Activity</Button>
                    )
                }
            </Segment>
        </Segment.Group>
