...
export const ActivityForm: React.FC<IProps> = ({ setEditMode, selectedActivity, saveNewActivity, updateExistingActivity }) => {
    ...
    return (
        <Segment clearing>
            <Form>
                ...
                <Button floated='right' content='Submit' type='submit' positive onClick={saveActivity} />
